...
export default async function ExpenseClaimPage() {
  ...
  const mockClaims = [
    { id: 1, employee: "John Smith", category: "Travel", amount: 450.00, date: "2025-01-15", status: "Pending" },
    { id: 2, employee: "Sarah Johnson", category: "Meals", amount: 120.50, date: "2025-01-14", status: "Approved" },
    { id: 3, employee: "Michael Chen", category: "Office Supplies", amount: 85.00, date: "2025-01-13", status: "Pending" },
    { id: 4, employee: "Emily Davis", category: "Software", amount: 299.00, date: "2025-01-12", status: "Approved" },
  ];

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Expense Claim</h1>
        <p className="text-gray-600 mt-2">
          Process and approve employee expense claims
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-800 mt-1">
              This page displays sample data for demonstration purposes. In a production environment, this would connect to real expense management systems.
            </p>
          </div>
        </div>
      </div>
