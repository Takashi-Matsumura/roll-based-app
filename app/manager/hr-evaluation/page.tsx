...
export default async function HREvaluationPage() {
  ...
  const mockEmployees = [
    { id: 1, name: "John Smith", department: "Engineering", rating: 4.5, lastReview: "2024-12-15" },
    { id: 2, name: "Sarah Johnson", department: "Marketing", rating: 4.8, lastReview: "2024-12-10" },
    { id: 3, name: "Michael Chen", department: "Sales", rating: 4.2, lastReview: "2024-12-08" },
    { id: 4, name: "Emily Davis", department: "Design", rating: 4.7, lastReview: "2024-12-05" },
  ];
                ...
                <tr key={employee.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm text-gray-600">
                      {new Date(employee.lastReview).toLocaleDateString("en-US")}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-800 mt-1">
              This page displays sample data for demonstration purposes. In a production environment, this would connect to real HR management systems.
            </p>
          </div>
        </div>
      </div>
